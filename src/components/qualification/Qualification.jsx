					...
					>
						<div className='qualification_data'>
							<div>
								...
								<span className='qualification_subtitle'>
									...
									<br />
									<span>
										{'\u2B24'} Kaya Founders Hackathon - 1st Runner Up
									</span>
									<br />
									<span>
										{'\u2B24'} DICT Philippine Startup Challenge 9 - Top 15
									</span>
									<br />
									...
									<br />
									<span>
										{'\u2B24'} FEU Tech ACM Codequest 2024 - 1st Runner Up and
										Best Poster Recipient
									</span>
									<br />
									<span>
										{'\u2B24'} ASES Manila ASES Bootcamp for Career Design 2024
										- 2nd Runner Up
									</span>
									<br />
									<span>
										{'\u2B24'} MAPUA NextGen IS StartUp Challenge 2024 - Top 4
									</span>
								</span>
						...
						<div className='qualification_data'>
							...
							<div>
								...
								<span className='qualification_subtitle'>
									University of Santo Tomas<br></br>Graduated with Honors
								</span>
								<div className='qualification_calendar'>
						...
						<div className='qualification_data'>
							<div>
								...
								<span className='qualification_subtitle'>
									Olivarez College <br></br>- Graduated with High Academic
									Distinctions
								</span>
								<span className='qualification_subtitle'>
									{'\u2B24'} Hon. Cong. Eric L. Olivarez Award of Academic
									Excellence Recipient
									<br></br>
									{'\u2B24'} Philippine Normal University (PNU) Regional
									Interschool Science and Mathematics Olympiad (PRISMO) 2019 -
									Top 30
									<br></br>
									{'\u2B24'} PSAP-ALAM Science Investigatory Project 1st
									Runner-Up
									<br></br>
									{'\u2B24'} PSAP-ALAM Best Presentor
								</span>
								<div className='qualification_calendar'>
						...
						<div className='qualification_data'>
							...
							<div>
								...
								<span className='qualification_subtitle'>
									{'\u2B24'} MathScore Competition - Bronze Medalist
								</span>
								<div className='qualification_calendar'>
									<i className='uil uil-calendar-alt'></i> Aug 2020 - June 2022
								</div>
					...
					>
						<div className='qualification_data'>
							<div>
								...
								<div className='qualification_calendar'>
									<i className='uil uil-calendar-alt'></i> June 2024 - August
									2024
								</div>
							</div>
