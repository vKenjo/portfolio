...
const Data = () => {
    return (
        <div className='home_data'>
            <h1 className='home_title'>Josh Viray {/*sadly need mo only iupdate padding*/}
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
           ...
           <p className='home_description'>Hi! I am Josh Kenn Viray, a third yeard computer science student specializing in Data Science. Nice to meet you!x</p>
